...
# dataTest, dataTestResult = csvParser("dataset/test_no_label_2.csv")
...
reportResults(classifier, X_test, y_test, predicted, "GNB-DS2.txt")

# Open plot windows
plt.show()

csvsave(predicted, "GNB-DS2.csv")